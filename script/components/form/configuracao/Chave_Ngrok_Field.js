...
class Chave_Ngrok_Field extends Base_Field {
  
    static i18n = {
        pt: {
            lbl_chave_ngrok    : "Chave do Servidor de Dados", 
            ph_chave_ngrok     : "Cole sua chave de teste aqui",
            tp_lbl_chave_ngrok : "Utilizado para acessar a aplicação em ambiente de testes",
        ...
        es: {
            lbl_chave_ngrok    : "Clave del servidor de datos", 
            ph_chave_ngrok     : "Pegue su clave de prueba aquí.",
            tp_lbl_chave_ngrok : "Se utiliza para acceder a la aplicación en un entorno de prueba.",
...
customElements.define('chave-ngrok-field', Chave_Ngrok_Field);