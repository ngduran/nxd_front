...
export const API_MAP = {
    ...
    PROFESSOR_GRADE: {
        CREATE_ITEM: { path: `${NXD_URL}${R_GRADE_PROFESSOR}/create-item`, method: 'POST' }
    },

    INSTITUICAO: {
        CREATE:  { path: `${NXD_URL}${R_INSTITUICAO}/create`,   method: 'POST' },
        FINDALL: { path: `${NXD_URL}${R_INSTITUICAO}/find-all`, method: 'GET'  },
    },

    ESTADO: {
        FINDALL:  { path: `${NXD_URL}${R_ESTADO}/find-all`, method: 'GET' },
    },
    
    MUNICIPIO: {
        POR_ESTADO:  { path: `${NXD_URL}${R_MUNICIPIO}/listar-por-estado`, method: 'GET' },
    },
    
    ADMINISTRACAO: {
        FINDALL:  { path: `${NXD_URL}${R_ADMINISTRACAO}/find-all`, method: 'GET' },
    },
